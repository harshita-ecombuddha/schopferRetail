...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#001F3F] text-[#F6FCDF] pt-8 pb-4 section border-t border-[#94B4C1]/40">
      <div className="max-w-7xl mx-auto px-6 space-y-4">
        {/* Top Section */}
        <div className="flex flex-col md:flex-row justify-between gap-12">
          {/* Left - Schopfer Brand */}
          <div className="flex items-center md:w-1/4 pl-[60px]">
            <h2 className="text-[46px] font-bold text-[#F6FCDF]">Schopfer</h2>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="w-full max-w-md">
              ...
              <div className="flex">
                ...
                <button
                  type="submit"
                  className="bg-lime-400 text-[#000] font-bold px-6 rounded-r hover:bg-lime-600 transition-colors ease-in-out duration-500"
                >
                  Submit
                </button>
              </div>
