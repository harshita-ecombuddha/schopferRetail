...
export default function Main() {
  ...
  return (
    <section className="w-full section min-h-screen bg-white text-[#333366] flex flex-col">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-center px-4 sm:px-6 md:px-12 lg:px-16 py-6 pt-26 sm:py-12  md:py-16 md:pt-24 lg:pt-20 lg:pb-26 max-w-7xl mx-auto flex-1">
        ...
        <div className=" flex flex-col items-start text-left max-w-2xl mb-2 sm:mb-10 lg:mb-0 w-full lg:mt-12">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl lg:text-[50px] font-bold leading-tight mb-2 sm:mb-4 lg:mb-1 text-[#333366]"> 
            <span className="bg-[#D6E8F9] text-[#333366] px-1 sm:px-2 rounded-md">Upgrade</span>{" "}
            Product Listings Into Sales Machines
          </h1>

          <p className="text-base sm:text-lg md:text-xl lg:text-[24px] font-semibold mb-4 sm:mb-6 lg:mb-6 text-[#333366]">
            Boost your E-commerce Sales with us.
          </p>

          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto">
            <button
              className="bg-[#333366] border-2 text-white font-bold py-2 sm:py-3 px-6 sm:px-8 rounded-lg flex items-center justify-center hover:bg-[#333366]/90 hover:text-white hover:border-2 ease-in-out duration-500 text-sm sm:text-base"
      ...
      {/* Stats Section */}
      <div className="bg-white text-[#333366] py-6 sm:py-8 lg:pt-3 lg:pb-2">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 text-center">
            <div className="flex flex-col items-center">
              <div className="bg-[#D6E8F9] text-[#000000] w-6 h-6 sm:w-8 sm:h-8 rounded-full flex items-center justify-center mb-2">
                <ShoppingCart className="w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5" />
              </div>
              <p className="text-xl sm:text-2xl lg:text-3xl lg:text-[20px] font-bold text-[#333366]">2,000+</p>
              <p className="text-xs sm:text-sm lg:text-[14px] mt-1 text-[#333366]">Brands Served</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-xl sm:text-2xl lg:text-3xl lg:text-[20px] font-bold text-[#333366]">1,239</p>
              <p className="text-xs sm:text-sm lg:text-[14px] mt-1 text-[#333366]">Listings Created</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-xl sm:text-2xl lg:text-3xl lg:text-[20px] font-bold text-[#333366]">21%</p>
              <p className="text-xs sm:text-sm lg:text-[14px] mt-1 text-[#333366]">Decrease in Returns</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-xl sm:text-2xl lg:text-3xl lg:text-[20px] font-bold text-[#333366]">89%</p>
              <p className="text-xs sm:text-sm lg:text-[14px] mt-1 text-[#333366]">Better Conversions</p>
            </div>
          </div>
        </div>
      </div>
